...
Generate a PNG thumbnail of the first slide of a presentation.

**Usage:**

```bash
pnpm supaslidev thumbnail <name> [options]
```
...
| Argument | Description                            | Required |
| -------- | -------------------------------------- | -------- |
| `name`   | Name of the presentation to thumbnail  | Yes      |

**Options:**

| Option                | Description                                      | Default                  |
| --------------------- | ------------------------------------------------ | ------------------------ |
| `-o, --output <path>` | Output path for the thumbnail (without extension) | `thumbnails/<name>` |

**Examples:**

```bash
# Generate thumbnail to default location
pnpm supaslidev thumbnail quarterly-review

# Generate thumbnail to custom path
pnpm supaslidev thumbnail quarterly-review --output ./images/cover
```

::callout{type="info" icon="i-heroicons-information-circle"}
The thumbnail is generated using Slidev's export with `--format png --range 1`, capturing just the first slide.
::
...
3. Generates a `presentations.json` catalog (including thumbnail URLs)
...
| `pnpm thumbnail <name>` | Generate PNG thumbnail of first slide          |
