...
const showBadge = useAltBadge(
  missingAlt,
  `[slidev-theme-supa11y] image: image "${props.image}" has no "alt" in frontmatter. Add alt: '…', or alt: '' if it is decorative.`,
);
</script>

<template>
  <div class="slidev-layout supa11y-image-full" :class="props.class">
    ...
    <div class="supa11y-image-content">
      <slot />
    </div>
  </div>
</template>
